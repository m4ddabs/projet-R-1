...
Pour calculer les intervalles de confiance pour la régression linéaire, nous supposons que les bruits suivent (approximativement) une distribution gaussienne. Cette hypothèse est valable en raison du théorème de la limite centrale lorsque le nombre d'échantillons est grand.
```{r}
#remove Na values
