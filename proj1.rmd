...
urgences  <- read.csv(file = "Donnees-20221103/URGENCES2_2019.csv",
                         header = TRUE, sep = ",", dec = ".")
...
Q20sub <- sqldf('select distinct "Label.modalité", "Valeur.Modalité",
                from Q20
                where "Variable" = "EFFSALPLF" or
                      "Variable" = "EFFSALPLH"')
...
for (i in 1:len) {
      ...
      Femmes_job_total <- sum2(Q20$"EFFSALPLF"[H_indices])
